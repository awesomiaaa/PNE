...
public class DuoMenuView extends RelativeLayout {
    ...
    private void handleHeader() {
        ...
        ImageView image = (ImageView) view.findViewById(R.id.duo_view_header_text_sub);

        Bitmap mbitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.bird)).getBitmap();
        ...
        TextView name1 = (TextView) view.findViewById(R.id.duo_view_header_text_sub_title);
//        name.setText("Welcome!");
        name1.setText("Hello User!");
        if (view != null) {
